...
import java.net.URL;
public class CartplaceorderTest {
  ...
  public void cartplaceorder() {
    ...
    driver.findElement(By.id("name")).sendKeys("Firman Aji Prasetyo");
    driver.findElement(By.id("country")).sendKeys("Indonesia");
    driver.findElement(By.id("city")).sendKeys("Kabupaten Magelang ");
